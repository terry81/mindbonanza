---
layout: post.njk
title: "End Your Day Mindfully: Wind Down and Sleep Well"
...
1. Lower lighting: dim lights and switch to warm bulbs or lamps.
2. Reduce stimulation: pause work and social media; choose calming activities (reading, light stretching, gentle music).
3. Do a short brain dump: write down any tasks, worries, or next-day logistics in a few lines so your mind can let them rest.
4. Create a simple ritual: pour a cup of caffeine-free tea, light a candle, or put on a favorite soft sweater—one small action that signals "transition to rest."
...
1. Lie down comfortably and set an intention: "I will allow my body to rest."
2. Take three slow breaths, exhaling longer than you inhale.
3. Perform a brief body scan: toes to head, pausing to soften each area.
4. If thoughts come, label them gently and return attention to the body.
5. End by placing one hand on the belly for a few breaths and allowing eyes to close.
