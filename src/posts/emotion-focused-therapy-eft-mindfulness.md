---
layout: post.njk
title: "Emotion-Focused Therapy (EFT) and Mindfulness: Accessing and Transforming Primary Emotions"
...
The answer lies in the distinction between **primary emotions**—your authentic, adaptive emotional responses—and **secondary emotions**—the defensive reactions that cover them up. Much of psychological suffering comes from being disconnected from your primary emotions, responding instead from secondary reactions that don't serve your actual needs.

**Emotion-Focused Therapy (EFT)**, developed by psychologist Leslie Greenberg, offers a sophisticated understanding of emotional experience and a structured approach to accessing and transforming emotions. At its core, EFT recognizes that emotions aren't just reactions to manage—they're essential information that, when accessed and processed mindfully, lead to profound healing and change.

When integrated with mindfulness, EFT becomes even more powerful—giving you the awareness to recognize different types of emotions, the presence to stay with difficult feelings, and the compassion to respond to your authentic emotional needs.
...
**EFT's revolutionary insight:** Emotions aren't irrational forces to be controlled—they're highly intelligent responses that provide crucial information about your needs, values, and well-being.
...
**When you can access and understand your emotions—especially primary emotions—they guide you toward what you need for well-being and authentic living.**
...
**EFT aims to help you access, allow, regulate, and transform emotions—especially the primary adaptive emotions that guide healthy functioning.**
...
- Partner forgets your birthday → hurt (primary) → anger (secondary)
- Criticism at work → shame (primary) → rage (secondary)
- Feeling abandoned → sadness (primary) → angry attack (secondary)
...
**What they are:** Emotions expressed to get a desired result rather than genuinely felt—emotional manipulation (often unconscious).
...
**Chair 1: The experiencing self** - The part feeling the emotion
**Chair 2: The other part** - Could be the critic, a protective part, a person you're in conflict with

**The process:**

1. **Sit in experiencing chair:** Express what you feel
2. **Switch to other chair:** Respond from that perspective  
3. **Continue switching:** Have a dialogue between perspectives
4. **Stay mindfully present:** Notice bodily sensations, emotions arising, impulses

**Example: Working with self-criticism**

**Experiencing chair:** "I feel so bad about myself. Like I can never do anything right."
**Critic chair:** "You ARE a disappointment. Look at all your failures."
**Experiencing chair:** "That's so harsh. I'm trying my best. I feel hurt when you talk to me this way."
**Critic chair:** [Often softens] "I'm just trying to protect you from failing again..."
**Experiencing chair:** "I know you're scared, but hurting me doesn't help."
...
1. **Imagine person in empty chair:** See them there
2. **Express your authentic feelings:** Say what needs to be said
3. **Switch chairs:** Respond as you imagine they might
4. **Continue dialogue:** Work toward resolution
...
1. **Clear a space:** Set aside thoughts about problems
2. **Choose something to explore:** One issue or feeling
3. **Sense into your body:** "How does this whole thing feel in my body?"
4. **Wait for a felt sense:** A bodily sensation that carries the quality of the whole situation
5. **Find a handle:** A word or image that fits the felt sense
6. **Resonate:** Check if the word/image fits. Body will signal yes or no
7. **Ask questions:** "What about this makes it feel [scared/heavy/stuck]?"
8. **Receive:** Let insights emerge without forcing
...
1. Pause and turn toward it
2. Name it: "This is sadness" or "This is anger"
3. Locate it: "Where do I feel this in my body?"
4. Explore it: "What's the quality? Heavy? Hot? Tight?"
5. Ask it: "What do you need me to know?"
6. Honor it: Take the action it guides you toward
...
1. Notice: "This feels like my pattern"
2. Pause: Don't immediately act on it
3. Breathe and soften: Create space
4. Ask: "What am I really feeling underneath?"
5. Wait with curiosity: Let the primary emotion emerge
6. Welcome it: "Ah, there's the hurt/fear/sadness"
...
**Goal:** Don't just express these old wounds—they need to be transformed by accessing new, contradictory emotional experiences.
...
1. Recognize: "This is my old shame/fear/helplessness"
2. Validate: "It makes sense I feel this way given my history"
3. Orient to now: "But where am I right now? What year is it?"
4. Access resource: What do I feel when I remember I'm safe/worthy/capable now?
5. Hold both: Let adult resources meet child wound
6. Notice shifts: How does my body/belief change?
...
**The shame doesn't just get expressed—it gets transformed by a new emotional truth.**

### The EFT Change Process: The Emotion Scheme

EFT views emotions as **emotion schemes**—complex networks of emotion, cognition, motivation, and bodily response.
...
2. **Scan your body:** Notice any sensations, tension, energy
3. **Name emotions present:** "I notice some anxiety... some excitement... tiredness"
4. **Distinguish layers:**
   - Is this primary or secondary?
   - If secondary, what might be underneath?
5. **Acknowledge needs:** "Today I might need [rest/connection/accomplishment/play]"
6. **Set intention:** "I'll check in with my emotions throughout the day"
...
**T - Take a breath:** Ground yourself
**O - Observe:** "What am I feeling? Where is it in my body? Primary or secondary?"
**P - Proceed:** Based on the wisdom of the emotion

**If primary adaptive:** Follow its guidance
**If secondary:** Explore what's beneath
**If primary maladaptive:** Validate and access new emotion
...
2. **Which were primary? Which secondary?**
3. **When I felt [emotion], what was the underlying need?**
4. **Did I honor my emotions or suppress them?**
5. **What am I learning about my emotional patterns?**

**Sample entry:**
*"Today when my boss gave feedback, I immediately felt angry (secondary). When I paused and checked in, I realized I felt hurt and inadequate (primary maladaptive shame). What I needed was to remind myself I'm competent, even when receiving constructive feedback. Next time, I'll try to access self-compassion instead of defensive anger."*
...
2. **Notice what emotions are present right now**
   - Don't force anything—just notice
   - Might be subtle: contentment, boredom, curiosity
   - Or strong: anxiety, sadness, frustration

3. **Choose one emotion to explore**
...
6. **Ask the emotion:**
   ...
   - "What do you need?"
   - Wait for what emerges—don't force answers

7. **If secondary, drop beneath:**
   - "What's underneath this?"
   - Wait with curiosity
   - Let primary emotion emerge

8. **Welcome whatever arises:**
...
**Your emotions—especially your primary adaptive emotions—are not problems to be solved but wise guides to living fully.** When you can access, allow, and follow them mindfully, they lead you toward what you truly need: connection, safety, joy, meaning, and authentic self-expression.
...
And gradually, emotion by emotion, moment by moment, you become more whole—no longer ruled by defensive reactions or old wounds, but guided by the intelligent, adaptive emotional wisdom that's been within you all along.
...
- [Attachment Styles and Mindfulness](/posts/attachment-styles-mindfulness/)
- [Mindful Self-Compassion (MSC) Program](/posts/mindful-self-compassion-msc-program/)
- [Schema Therapy and Mindfulness](/posts/schema-therapy-mindfulness/)

---

*Emotion-Focused Therapy reveals that beneath defensive reactions lie your authentic primary emotions—intelligent guides to what you truly need. Through mindful awareness and skilled emotional processing, you can access this wisdom, transform old wounds, and live with greater emotional freedom and authentic connection.*
